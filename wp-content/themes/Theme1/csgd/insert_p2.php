<?php if ($_SESSION['insert_p2'] != 1 && !isset($_POST['submit_trang2'])) { ?>
  	...
  	<div class="panel-body">
    	<form action="" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4"><input type="file" name="II12" id="file" class="form-control"></div>
            </div>
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-5">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td>Chính quy</td>
                                <td><input type="radio" name="II14a" value="1"></td>
                                <td><input type="radio" name="II14a" value="0"></td>
                            </tr>
                            <tr>
                                <td>Không chính quy</td>
                                <td><input type="radio" name="II14b" value="1"></td>
                                <td><input type="radio" name="II14b" value="0"></td>
                            </tr>
                            <tr>
                                <td>Từ xa</td>
                                <td><input type="radio" name="II14c" value="1"></td>
                                <td><input type="radio" name="II14c" value="0"></td>
                            </tr>
                            <tr>
                                <td>Liên kết đào tạo với nước ngoài</td>
                                <td><input type="radio" name="II14d" value="1"></td>
                                <td><input type="radio" name="II14d" value="0"></td>
                            </tr>
                            <tr>
                                <td>Liên kết đào tạo trong nước</td>
                                <td><input type="radio" name="II14e" value="1"></td>
                                <td><input type="radio" name="II14e" value="0"></td>
                            </tr>
                            <tr>
                                <td>Các loại hình đào tạo khác</td>
                                <td><input type="radio" name="II14f" value="1"></td>
                                <td><input type="radio" name="II14f" value="0"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="form-group col-md-12">
                    <div class="col-md-4"><label for="">Liệt kê tên các khoa đào tạo</label><input type="file" name="II15b" id="file" class="form-control"> </div>
                    <!-- <div class="col-md-12">
                        <table class="table table-striped table-hover" id="II15b_lietketencackhoadaotao">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Tên khoa</th>
...
<?php  } else if (isset($_POST['submit_trang2'])) { 
    $trang = $_GET['trang'];
    $trangtiep = $trang+1;
?>
